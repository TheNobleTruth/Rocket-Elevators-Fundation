class InterventionsController < ApplicationController
  ...
  #   @intervention = LeaInterventiond.new(lead_params)
  ...
  #           status: 2,
  #           priority: 1,
  #           subject: "#{@intervention.status} from #{@intervention.author}", 
  #           description: "The contact #{@intervention.full_name}  from company #{@lead.company_name} can be reached at email #{@lead.email} and at phone number #{@lead.phone}. #{@lead.department_in_charge_of_elevators} has a project named #{@lead.project_name} which would require contribution from Rocket Elevators.\nProject Description: #{@lead.project_description}\n#{@lead.message}.\nThe Contact uploaded an attachment",
  #           email: "#{@lead.email}",
  #           type:"Question"
  #         }
